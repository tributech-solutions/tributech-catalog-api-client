...
namespace Tributech.Dsk.CatalogApi.Client {
	public class APIAuthHandler: DelegatingHandler {
		...
		/// </summary>
		/// <param name="authUrl">Your Hub URL (e.g.  https://auth.your-hub.dataspace-hub.com/auth/realms/your-node/protocol/openid-connect/token, replace your-hub with the name of your hub and your-node with the name of your node)</param>
